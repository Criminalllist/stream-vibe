...
class Select extends BaseComponent {
  ...
  stateClasses = {
    ...
    isOneTheLeftSide: 'is-one-the-left-side',
    isOneTheRightSide: 'is-one-the-right-side',
  }
  ...
  fixDropDownPosition = () => {
    ...
    this.dropdownElement.classList.toggle(
      this.stateClasses.isOneTheLeftSide, isButtonOnTheLeftViewportSide
    );

    this.dropdownElement.classList.toggle(
      this.stateClasses.isOneTheRightSide, !isButtonOnTheLeftViewportSide
    );
  ...
  onClick = (event) => {
    ...
    if(isOptionClick){
      ...
      this.state.currentOptionIndex = [...this.optionElements]
        .findIndex((option)=> option === target);
      this.collapse();
    }
  }
